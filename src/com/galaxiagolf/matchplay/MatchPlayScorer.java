...
//            clientIds = {"c0", "c1"}
    ...
    public Tournament postTournament(Tournament newTournament) throws BadRequestException
    {
...
//            clientIds = {"c0", "c1"}
    ...
    public Tournament putTournament(HttpServletRequest req, @Named(TOURNAMENT_ID_PARAM) Long tournamentId, Tournament newData) throws ServiceException
    {
        ...
        {
            Match m = it.next();
            m.setPassKey(theTournament.getPassKey());


            if (m.getId()==null) // new match
            {
                m.setId(null); // make sure ID is auto-generated by the data store
